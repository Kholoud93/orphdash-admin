...
import AppSearchDropdown from "./AppSearchDropdown.vue";
...
<template>
  <div class="relative ml-auto hidden max-w-md flex-1 md:block">
    ...
    <input
      ...
      class="w-full rounded-xl border bg-card py-2 pl-9 pr-3 text-sm outline-none placeholder:text-muted-foreground focus:border-ring focus:ring-2 focus:ring-ring/20"
