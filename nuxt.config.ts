...
export default defineNuxtConfig({
    ...
    modules: ['@nuxt/ui', '@nuxt/image', '@nuxt/fonts', '@nuxtjs/color-mode', '@pinia/nuxt', '@vueuse/nuxt', '@nuxtjs/i18n', '@nuxt/eslint'],
    runtimeConfig: {
        public: {
            siteUrl: process.env.NUXT_PUBLIC_SITE_URL ?? '',
            authBaseUrl: process.env.NUXT_PUBLIC_AUTH_BASE_URL ?? 'https://dummyjson.com/auth',
        },
    },
